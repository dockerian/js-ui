...
#   GITHUB_REPO - the github repository name (default: js-ui)
#   GITHUB_USER - the github user (default: dockerian)
#   DOCKER_USER - the docker user (default: dockerian)
#   DOCKER_NAME - default: js-ui, as in ${DOCKER_USER}/${DOCKER_NAME}
